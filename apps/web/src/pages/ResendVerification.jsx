    ...
    <div className="min-h-screen flex items-center justify-center bg-muted/40 p-4">
      <div className="w-full max-w-md">
        ...
        <div className="flex flex-col items-center space-y-2 text-center mb-8">
          ...
          <p className="text-muted-foreground text-sm">Resend verification email</p>
        </div>

        {/* Card */}
        <div className="card">
          <div className="card-header space-y-1 text-center">
            <h2 className="card-title text-xl">Verify your email</h2>
              ...
              <div className="text-center space-y-6 animate-in fade-in zoom-in-95 duration-300">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground text-sm">
                    If an unverified account exists for <span className="font-medium text-foreground">{email}</span>, we've sent a verification link.
                  </p>
                </div>
